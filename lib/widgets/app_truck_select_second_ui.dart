...
class AppTruckTypeWidgetSecondUI extends StatefulWidget {
  final Function onChanged;
  final TruckType defaultValue;
  final bool enable;

  const AppTruckTypeWidgetSecondUI({Key key, this.onChanged, this.defaultValue, this.enable = true})
      : super(key: key);
...
class _AppTruckTypeWidgetState extends State<AppTruckTypeWidgetSecondUI> {
